...
*/
@TableName("ziyua")
public class ZiyuaView extends ZiyuaEntity implements Serializable {
	...
	*/
	...
	public ZiyuaView(ZiyuaEntity ziyuaEntity) {
		try {
			BeanUtils.copyProperties(this, ziyuaEntity);
