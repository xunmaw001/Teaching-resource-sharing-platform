...
public class ZiyuaLiuyanView extends ZiyuaLiuyanEntity implements Serializable {
	...
	public ZiyuaLiuyanView() {

	}

	public ZiyuaLiuyanView(ZiyuaLiuyanEntity ziyuaLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, ziyuaLiuyanEntity);
