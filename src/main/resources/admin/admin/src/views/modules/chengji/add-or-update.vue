    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="科目" prop="chengjiKemu">
                       <el-input v-model="ruleForm.chengjiKemu"
                                 placeholder="科目" clearable  :readonly="ro.chengjiKemu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="科目" prop="chengjiKemu">
                           <el-input v-model="ruleForm.chengjiKemu"
